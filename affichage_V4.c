...
/*----- Lancement SDL ------------------------------------------------------------------------*/
	...
	if (Mix_OpenAudio(44100, MIX_DEFAULT_FORMAT, MIX_DEFAULT_CHANNELS, 1024)<0) printf("erroer\n");
	Mix_Chunk * background_sound = Mix_LoadWAV("500Hz.wav");
